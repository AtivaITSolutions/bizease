    ...
    <div class="upperFooter">
      ...
      <div class="right">
        ...
        <ul>
          ...
          <li>
            Email: <a href="mailto:" aria-label="Email">abc@abc.com</a>
          </li>
          <li>
            Phone: <a href="tel:" aria-label="Mobile">+1234567890</a>
          </li>
          <li class="socailMedia">
            <div class="socailmediaBox">
              <span class="socIcon">
                <a href="javascript:void(0);" target="_blank" aria-label="facebook" title="facebook">
              ...
              <span class="socIcon">
                <a href="javascript:void(0);" target="_blank" aria-label="instagram" title="instagram">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
